...
// Page
export default function Suggestion({ categories }: Props) {
  // Hooks
  ...
  useEffect(() => {
    ...
    const filteredKeywords = searchKeywords.filter((k) =>
      categories.some((c) => c === k.name)
    );
    console.log('filteredKeywords', filteredKeywords);
    // Pending counter reset
    pendingRef.current = filteredKeywords.length;
  ...
  }, [map, currentLocation, keywordResultState, categories]);
